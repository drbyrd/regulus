...
<legend>Author Meta Form!</legend>
...
<div class="form-group">
	...
	<input  name="first_name" placeholder="Author ID" class="form-control"  type="text">
		</div>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="input-group">
	<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
	<input  name="first_name" placeholder="Author Name" class="form-control"  type="text">
		</div>
	</div>
</div>
<hr>
...
<div class="form-group">
	<label class="col-md-4 control-label" >Author Website</label>
		<div class="col-md-4 inputGroupContainer">
		<div class="input-group">
	<span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
	<input name="last_name" placeholder="Author Website" class="form-control"  type="text">
		</div>
	</div>
</div>
...
<div class="form-group">
	<label class="col-md-4 control-label" >Author URI</label>
		<div class="col-md-4 inputGroupContainer">
		<div class="input-group">
...
<!-- Text input-->
			 <div class="form-group">
	<label class="col-md-4 control-label">Author Discription</label>
		<div class="col-md-4 inputGroupContainer">
		<div class="input-group">
